...
func (e UserEdges) ClaimGroupsOrErr() ([]*ClaimGroup, error) {
	if e.loadedTypes[0] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldFname, user.FieldLname, user.FieldSource, user.FieldEmail, user.FieldUsername, user.FieldPassword, user.FieldSalt:
...
// QueryClaimGroups queries the "claim_groups" edge of the User entity.
func (u *User) QueryClaimGroups() *ClaimGroupQuery {
	return NewUserClient(u.config).QueryClaimGroups(u)
}
